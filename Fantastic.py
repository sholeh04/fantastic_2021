...
║║──║╔═╗║║─║║║─║║─║╔═╗║╚═╝║─║║─╔╣╠╣╚═╝║
╚╝──╚╝─╚╩╝─╚═╝─╚╝─╚╝─╚╩═══╝─╚╝─╚══╩═══╝
\033[1;96mAuthor   : SHOLEH ID
\033[1;96mWhatsApp : 081236881601
...
def pilih_masuk():
	msuk = raw_input("\033[1;93mBY ShHOLEH ID \033[91m:\033[1;96m ")
	if msuk =="":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://m.facebook.com/user.morena.sumba')
				bot_komen()
...
def bot_komen():
	try:
		...
		os.system('rm -rf login.txt')
	una = ('100004254376539')
	kom = ('GUE PAKE SCRIPT LU YA MASTER SHOLEH 😘😘😘')
	reac = ('ANGRY')
...
######PILIH######
def pilih():
	unikers = raw_input("\033[1;93mBY SHOLEH ID \033[91m:\033[1;96m ")
	if unikers =="":
...
#### PILIH INDO ####
def pilih_indo():
	teak = raw_input("\033[1;93mBY SHOLEH ID \033[91m:\033[1;96m ")
	if teak =="":
		print"\033[1;97m[\033[1;91m!\033[1;97m]\033[1;97m Isi Yg Benar !"
		pilih_indo()
